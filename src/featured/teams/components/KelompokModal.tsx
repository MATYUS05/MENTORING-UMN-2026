...
export default function KelompokModal({ kelompok, peserta, keyword, isOpen, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4">
      <div
        className="relative flex max-h-[85vh] w-full max-w-2xl flex-col animate-[popIn_0.18s_cubic-bezier(0.16,1,0.3,1)]"
        style={{ containerType: 'inline-size' }}
      >
        <div style={gayaKertasModal} aria-hidden />
        ...
        <div className="relative flex min-h-0 flex-1 flex-col px-[6cqw] pt-[5cqw] pb-[6cqw]">
          <div className="flex shrink-0 items-start gap-4 border-b-4 border-dashed border-[#C9793E]/60 pb-4">
            ...
            <button
              ...
              onClick={onClose}
              aria-label="Tutup"
              className="shrink-0 rounded-full border-2 border-[#7A4A24]/70 bg-[#FBEAD5] p-1.5 text-[#7A4A24] transition hover:bg-white"
            >
              <svg
                viewBox="0 0 24 24"
                fill="none"
